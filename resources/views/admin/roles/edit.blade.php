<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Edit Role: <span class="capitalize">{{ $role->name }}</span>
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.roles.update', $role) }}">
                        ...
                        {{-- Checkbox Permission
                             - Checkbox akan otomatis tercentang jika role sudah punya permission tersebut
                             - Menggunakan $rolePermissions yang dikirim dari controller
                        --}}
                        <div class="mb-6">
                                        ...
                                        @foreach ($groupPermissions as $permission)
                                            <label class="flex items-center gap-2 text-sm text-gray-700 cursor-pointer">
                                                <input type="checkbox"
                                                       ...
                                                       {{--
                                                           Centang jika:
                                                           - Ada old() input (saat validasi gagal), ATAU
                                                           - Role memang punya permission ini ($rolePermissions)
                                                       --}}
